                ...
                <aside className={`w-72 border-${isRTL ? 'l' : 'r'} border-gray-100 flex flex-col p-8 sticky top-[73px] h-[calc(100vh-73px)] shrink-0 bg-white`}>
                    <div className="flex-1 space-y-2">
                        ...
                        >
                            ...
                            <span className="text-[14px]">{t.profile.sidebar.profile}</span>
                        </button>
                        
                        <button
                            onClick={() => setActiveTab('favorites')}
                            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 ${activeTab === 'favorites'
                                ? 'bg-primary/10 text-primary font-bold shadow-sm'
                                : 'text-gray-500 hover:bg-gray-50 font-medium'
                                }`}
                        >
                            ...
                            <span className="text-[14px]">{t.profile.sidebar.favorites}</span>
                        </button>
                        ...
                        >
                            ...
                            <span className="text-[14px]">{t.profile.sidebar.reviews}</span>
                        </button>
                        ...
                        >
                            ...
                            <span className="text-[14px]">{t.profile.sidebar.settings}</span>
                        </button>
