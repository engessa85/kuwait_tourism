                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="flex gap-4">
                            {/* Instagram */}
                            <a href="https://www.instagram.com/kuwaittourismonline" aria-label="Instagram" className="w-10 h-10 rounded-full border border-gray-100 flex items-center justify-center hover:bg-primary hover:border-primary hover:text-white text-gray-500 transition-all duration-300">
                            ...
                            {/* Twitter / X */}
                            <a href="https://x.com/kwtourismonline" aria-label="Twitter" className="w-10 h-10 rounded-full border border-gray-100 flex items-center justify-center hover:bg-primary hover:border-primary hover:text-white text-gray-500 transition-all duration-300 text-left rtl:text-right">
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                                </svg>
                            </a>
                            {/* Email */}
                            <a href="mailto:kuwaittourismonline@gmail.com" aria-label="Email" className="w-10 h-10 rounded-full border border-gray-100 flex items-center justify-center hover:bg-primary hover:border-primary hover:text-white text-gray-500 transition-all duration-300">
